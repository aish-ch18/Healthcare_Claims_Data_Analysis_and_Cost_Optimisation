...
lottie_insurance = load_lottie_url("https://assets1.lottiefiles.com/packages/lf20_jcikwtux.json")
lottie_report = load_lottie_url("https://assets7.lottiefiles.com/packages/lf20_iwmd6pyr.json")
